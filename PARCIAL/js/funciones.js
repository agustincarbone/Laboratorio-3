...
function generadorLista(personas)
{
    personas.forEach(element => {
        GuardarDatosServidor(element);
    });
           
}

//Carga en la tabla los datos del servidor
function GuardarDatosServidor (element)
{
    var nombre;
    var apellido;
    var sexo;
    ...
    if (element)
    {
        ...
        var fila = "<div class='card' id='card'><br>"+img+"<br>"+"<label for='nombre'>"+nombre+"</label><br>"+
        "<label for='apellido'>"+apellido+"</label><br>"+"<label for='sexo'>"+sexo+"</label><br></div>";
    }
    else
    {
        console.log("No se cargaron los datos");
    }
    document.getElementById("cards").innerHTML +=fila;
